...
``` json
{ "dependencies": { "twikoo-func": "1.6.3" } }
```
...
``` html
<div id="tcomment"></div>
<script src="https://cdn.jsdelivr.net/npm/twikoo@1.6.3/dist/twikoo.all.min.js"></script>
<script>
twikoo.init({
...
* `https://cdn.staticfile.org/twikoo/1.6.3/twikoo.all.min.js`
* `https://lib.baomitu.com/twikoo/1.6.3/twikoo.all.min.js`
* `https://cdn.bootcdn.net/ajax/libs/twikoo/1.6.3/twikoo.all.min.js`
* `https://cdn.jsdelivr.net/npm/twikoo@1.6.3/dist/twikoo.all.min.js`
