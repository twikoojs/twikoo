...
* `https://cdn.staticfile.org/twikoo/1.6.19/twikoo.all.min.js`
* `https://lib.baomitu.com/twikoo/1.6.19/twikoo.all.min.js`
* `https://cdn.bootcdn.net/ajax/libs/twikoo/1.6.19/twikoo.all.min.js`
* `https://cdn.jsdelivr.net/npm/twikoo@1.6.19/dist/twikoo.all.min.js`
