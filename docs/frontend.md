...
``` html
<div id="tcomment"></div>
<script src="https://cdn.jsdelivr.net/npm/twikoo@1.7.6/dist/twikoo.min.js"></script>
<script>
twikoo.init({
...
* `https://registry.npmmirror.com/twikoo/1.7.6/files/dist/twikoo.min.js`
* `https://s4.zstatic.net/npm/twikoo@1.7.6/dist/twikoo.min.js`

#### 推荐在全球使用

* `https://cdn.jsdelivr.net/npm/twikoo@1.7.6/dist/twikoo.min.js`
