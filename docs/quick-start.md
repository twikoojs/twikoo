...
``` json
{ "dependencies": { "twikoo-func": "1.5.6" } }
```
...
``` html
<div id="tcomment"></div>
<script src="https://cdn.jsdelivr.net/npm/twikoo@1.5.6/dist/twikoo.all.min.js"></script>
<script>
twikoo.init({
...
引入的 CDN 链接替换为如下即可：`https://lib.baomitu.com/twikoo/1.5.6/twikoo.all.min.js`
