...
``` json
{ "dependencies": { "twikoo-func": "0.6.1" } }
```
...
comments:
  twikoo:
    js: https://cdn.jsdelivr.net/npm/twikoo@0.6.1/dist/twikoo.all.min.js
...
``` html
<div id="tcomment"></div>
<script src="https://cdn.jsdelivr.net/npm/twikoo@0.6.1/dist/twikoo.all.min.js"></script>
<script>
twikoo.init({
  envId: '您的环境id',
  el: '#tcomment',
