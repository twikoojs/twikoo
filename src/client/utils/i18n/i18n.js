...
export const idI18n = {
  ADMIN_CLIENT_VERSION: 'Versi klien: ',
  ADMIN_SERVER_VERSION: 'Versi server: ',

  [S.AC]: 'Komentar',
  [S.AC + '_DELETE']: 'Hapus',
  [S.AC + '_DELETE_CONFIRM']: 'Yakin ingin menghapus?',
  [S.AC + '_FILTER_ALL']: 'Semua',
  [S.AC + '_FILTER_VISIBLE']: 'Terlihat',
  [S.AC + '_FILTER_HIDDEN']: 'Tersembunyi',
  [S.AC + '_HIDE']: 'Sembunyikan',
  [S.AC + '_IS_SPAM_SUFFIX']: ' (Tersembunyi)',
  [S.AC + '_SEARCH']: 'Cari',
  [S.AC + '_SEARCH_PLACEHOLDER']: 'Cari berdasarkan nama, email, website, IP, komentar, atau path artikel',
  [S.AC + '_SHOW']: 'Tampilkan',
  [S.AC + '_TOP']: 'Sematkan',
  [S.AC + '_UNTOP']: 'Lepas sematan',
  [S.AC + '_VIEW']: 'Lihat',
  [S.AC + '_SECURITY_ALERT']: 'Tautan komentar berbeda dari situs ini. Demi keamanan, salin URL berikut secara manual untuk membukanya:',
  [S.AC + '_PARSE_ERROR']: 'Tautan komentar tidak dapat dibaca. Periksa tautannya, lalu salin URL berikut secara manual:',

  ADMIN_CONFIG: 'Konfigurasi',
  [S.ACC + '_COMMON']: 'Umum',
  [S.ACC + '_IM']: 'Notifikasi instan',
  [S.ACC + '_MAIL']: 'Notifikasi email',
  [S.ACC + '_PLUGIN']: 'Plugin',
  [S.ACC + '_PRIVACY']: 'Privasi',
  [S.ACC + '_SPAM']: 'Anti-spam',
  [S.ACC + '_CAPTCHA']: 'CAPTCHA',

  ADMIN_CONFIG_IMAGE_CDN_NONE: 'Tidak ada (nonaktifkan unggah gambar)',
  ADMIN_CONFIG_CAPTCHA_NONE: 'Tidak ada',
  ADMIN_CONFIG_CAPTCHA_TURNSTILE: 'Cloudflare Turnstile',
  ADMIN_CONFIG_CAPTCHA_GEETEST: 'GeeTest',
  ADMIN_CONFIG_CAPTCHA_CAP: 'Cap',

  ADMIN_CONFIG_EMAIL_TEST: 'Tes notifikasi email',
  ADMIN_CONFIG_EMAIL_TEST_BTN: 'Kirim email tes',
  ADMIN_CONFIG_EMAIL_TEST_HELP: 'Masukkan alamat email lalu kirim email tes',
  ADMIN_CONFIG_EMAIL_TEST_RESULT: 'Hasil tes: ',
  ADMIN_CONFIG_EXAMPLE: 'Contoh: ',

  [S.ACI + '_AKISMET_KEY']: 'Perlindungan spam Akismet. Isi "MANUAL_REVIEW" untuk mengaktifkan moderasi manual. Kosongkan jika tidak memakai anti-spam. Daftar Akismet: https://akismet.com',
  [S.ACI + '_BLOGGER_NICK']: 'Nama admin.',
  [S.ACI + '_BLOGGER_EMAIL']: 'Alamat email admin. Digunakan untuk notifikasi email dan identifikasi admin.',
  [S.ACI + '_COMMENT_BG_IMG']: 'URL gambar latar khusus untuk kotak komentar.',
  [S.ACI + '_COMMENT_PAGE_SIZE']: 'Jumlah komentar per halaman. Default: 8.',
  [S.ACI + '_COMMENT_PLACEHOLDER']: 'Teks placeholder komentar. Gunakan <br> untuk baris baru. Default: kosong.',
  [S.ACI + '_CORS_ALLOW_ORIGIN']: 'Domain yang diizinkan CORS. Catatan: pengaturan yang salah dapat membuat komentar gagal dimuat. Default: kosong. Format: https://blog.example.com. Untuk beberapa domain, pisahkan dengan koma.',
  [S.ACI + '_DEFAULT_GRAVATAR']: `Avatar default. Default jika kosong: "initials". Pilihan: ${defaultGravatar.join(', ')}`,
  [S.ACI + '_EMOTION_CDN']: 'CDN emoji. Pisahkan dengan koma. Default: https://owo.imaegoo.com/owo.json',
  [S.ACI + '_FORBIDDEN_WORDS']: 'Konfigurasi kata terlarang. Komentar yang mengandung kata ini akan langsung ditandai sebagai spam. Pisahkan dengan koma.',
  [S.ACI + '_BLOCKED_WORDS']: 'Konfigurasi kata yang diblokir. Komentar yang mengandung kata ini akan gagal dikirim. Pisahkan dengan koma.',
  [S.ACI + '_GRAVATAR_CDN']: 'CDN avatar khusus. Contoh: gravatar.com. Default: weavatar.com.',
  [S.ACI + '_HIDE_ADMIN_CRYPT']: 'Atur sandi rahasia untuk menyembunyikan tombol masuk panel admin. Tombol admin hanya muncul jika sandi yang sama dimasukkan pada kolom nama. Kosongkan jika tidak ingin menyembunyikan tombol admin.',
  [S.ACI + '_QQ_API_KEY']: 'API key nama panggilan QQ untuk mengambil nickname QQ. Ambil dari https://api.nsuuu.com/admin/key',

  [S.ACI + '_HIGHLIGHT']: 'Aktifkan highlight kode. Jika tema kamu bentrok dengan highlight kode, ubah menjadi false. Default: true.',
  [S.ACI + '_HIGHLIGHT_THEME']: `Tema highlight kode. Pilihan: ${highlightThemes.join(', ')}. Kunjungi https://prismjs.com untuk pratinjau. Jika tema bentrok dengan highlight kode, atur ke none. Default: none.`,
  [S.ACI + '_HIGHLIGHT_PLUGIN']: `Plugin highlight kode. Pilihan: ${highlightPlugins.join(', ')}. Masing-masing untuk menampilkan bahasa kode dan tombol salin kode. Bisa memakai beberapa opsi sekaligus. Jika tidak ingin memakai plugin highlight kode, atur ke none. Default: none.`,
  [S.ACI + '_IMAGE_CDN']: `Layanan penyimpanan gambar untuk unggah gambar. Pilihan: ${imageBedServices.join(', ')}`,
  [S.ACI + '_IMAGE_CDN_URL']: `URL layanan penyimpanan gambar. Wajib diisi jika IMAGE_CDN memakai salah satu dari: ${customImageBedServices.join(', ')}`,
  [S.ACI + '_IMAGE_CDN_TOKEN']: 'Token layanan penyimpanan gambar. Tidak diperlukan untuk qcloud.',
  [S.ACI + '_NSFW_API_URL']: 'URL API deteksi gambar tidak pantas. Layanan gratis: nsfw.xnet.ren, nsfw.qixz.cn, proyek: github.com/HG-ha/nsfwpy',
  [S.ACI + '_NSFW_THRESHOLD']: 'Ambang deteksi gambar tidak pantas (0-1). Unggahan akan ditolak jika skor melebihi nilai ini. Default: 0.5',

  [S.ACI + '_S3_REGION']: 'Region S3, contoh us-east-1. Bisa diisi nilai apa saja saat memakai layanan kompatibel S3 seperti Cloudflare R2 atau MinIO.',
  [S.ACI + '_S3_BUCKET']: 'Nama bucket S3',
  [S.ACI + '_S3_ACCESS_KEY_ID']: 'S3 Access Key ID',
  [S.ACI + '_S3_SECRET_ACCESS_KEY']: 'S3 Secret Access Key',
  [S.ACI + '_S3_ENDPOINT']: 'Endpoint khusus S3. Wajib saat memakai layanan kompatibel S3 seperti Cloudflare R2 atau MinIO.',
  [S.ACI + '_S3_FORCE_PATH_STYLE']: 'Saat S3_ENDPOINT diatur, tentukan apakah S3_BUCKET ikut ditambahkan ke path URL unggahan. Default: true. Gunakan true untuk Cloudflare R2, MinIO, dan endpoint kompatibel S3 berbasis path-style. Gunakan false untuk custom domain yang sudah terhubung ke bucket.',
  [S.ACI + '_S3_CDN_URL']: 'Domain akses gambar S3 (domain CDN). Kosongkan untuk memakai URL S3/Endpoint default.',
  [S.ACI + '_S3_PATH_PREFIX']: 'Prefix path penyimpanan gambar S3, contoh images/twikoo. Kosongkan untuk menyimpan di root.',
  [S.ACI + '_LIGHTBOX']: 'Gunakan efek lightbox sederhana. Default: false.',

  [S.ACI + '_LIMIT_PER_MINUTE']: 'Batas jumlah komentar per IP setiap 10 menit. Isi 0 untuk tanpa batas. Default: 10.',
  [S.ACI + '_LIMIT_PER_MINUTE_ALL']: 'Batas jumlah komentar seluruh situs setiap 10 menit. Isi 0 untuk tanpa batas. Default: 10.',
  [S.ACI + '_LIMIT_LENGTH']: 'Batas panjang komentar. Isi 0 untuk tanpa batas. Default: 500.',

  [S.ACI + '_MAIL_SUBJECT']: 'Subjek email notifikasi khusus. Kosongkan untuk memakai subjek default.',
  [S.ACI + '_MAIL_SUBJECT_ADMIN']: 'Subjek email notifikasi admin khusus. Kosongkan untuk memakai subjek default.',
  [S.ACI + '_MAIL_TEMPLATE']: 'Template email notifikasi khusus. Kosongkan untuk memakai template default. Field yang dapat digunakan: ${SITE_URL}, ${SITE_NAME}, ${PARENT_NICK}, ${PARENT_COMMENT}, ${NICK}, ${COMMENT}, ${POST_URL}, ${IMG}, ${PARENT_IMG}',
  [S.ACI + '_MAIL_TEMPLATE_ADMIN']: 'Template email notifikasi admin khusus. Kosongkan untuk memakai template default. Field yang dapat digunakan: ${SITE_URL}, ${SITE_NAME}, ${NICK}, ${COMMENT}, ${POST_URL}, ${IP}, ${MAIL}, ${IMG}',
  [S.ACI + '_MASTER_TAG']: 'Label khusus untuk admin.',
  [S.ACI + '_NOTIFY_SPAM']: 'Kirim notifikasi untuk komentar spam. Default: true.',

  [S.ACI + '_CAPTCHA_PROVIDER']: 'Penyedia CAPTCHA',
  [S.ACI + '_TURNSTILE_SITE_KEY']: 'Site Key Turnstile CAPTCHA. Ambil dari: https://dash.cloudflare.com/?to=/:account/turnstile',
  [S.ACI + '_TURNSTILE_SECRET_KEY']: 'Secret Key Turnstile CAPTCHA',
  [S.ACI + '_GEETEST_CAPTCHA_ID']: 'GeeTest CAPTCHA ID. Ambil dari: https://console.geetest.com/sensbot/management',
  [S.ACI + '_GEETEST_CAPTCHA_KEY']: 'GeeTest CAPTCHA Key',
  [S.ACI + '_CAP_API_ENDPOINT']: 'Endpoint API Cap CAPTCHA (format: https://<instance_url>/<site_key>/)',
  [S.ACI + '_CAP_SECRET_KEY']: 'Secret Key Cap CAPTCHA',

  [S.ACI + '_QCLOUD_SECRET_ID']: 'Tencent Cloud secret id untuk deteksi spam. Jika Tencent Cloud dan Akismet diatur bersamaan, hanya Tencent Cloud yang berlaku. Daftar: https://twikoo.js.org/cms.html',
  [S.ACI + '_QCLOUD_CMS_BIZTYPE']: 'Nama Biztype Tencent Cloud Content Security untuk kebijakan spam komentar. Aturan blokir spam dapat disesuaikan.',
  [S.ACI + '_QCLOUD_SECRET_KEY']: 'Tencent Cloud secret key.',

  [S.ACI + '_PUSHOO_CHANNEL']: `Channel push notifikasi instan. Mendukung: ${pushooChannels.join(', ')}`,
  [S.ACI + '_PUSHOO_TOKEN']: 'Token push notifikasi instan. Lihat https://pushoo.js.org untuk detail.',
  [S.ACI + '_DISPLAYED_FIELDS']: 'Kolom input yang ditampilkan di antarmuka. Default: nick,mail,link',
  [S.ACI + '_REQUIRED_FIELDS']: 'Kolom wajib untuk komentar. Isi "nick,mail,link" berarti semua kolom wajib. Isi "none" berarti semua kolom opsional. Default: nick,mail.',
  [S.ACI + '_SC_MAIL_NOTIFY']: 'Kirim notifikasi ke admin melalui pesan instan dan email sekaligus. Default-nya hanya melalui pesan instan. Default: false.',
  [S.ACI + '_SENDER_EMAIL']: 'Alamat email untuk notifikasi email. Untuk sebagian besar penyedia email, SENDER_EMAIL harus sama dengan SMTP_USER, jika tidak email bisa gagal dikirim.',
  [S.ACI + '_SENDER_NAME']: 'Judul untuk notifikasi email.',
  [S.ACI + '_SHOW_EMOTION']: 'Aktifkan emoji. Default: true.',
  [S.ACI + '_SHOW_IMAGE']: 'Aktifkan unggah gambar. Default: true.',
  [S.ACI + '_SHOW_ORDER']: 'Tampilkan dropdown pengurutan. Default: true.',
  [S.ACI + '_SHOW_DISLIKE']: 'Tampilkan tombol tidak suka. Default: true.',
  [S.ACI + '_SHOW_UA']: 'Tampilkan OS dan browser pengguna. Default: true.',
  [S.ACI + '_SHOW_REGION']: 'Tampilkan wilayah IP pengguna. Default: false.',
  [S.ACI + '_SITE_NAME']: 'Nama website.',
  [S.ACI + '_SITE_URL']: 'URL website.',
  [S.ACI + '_SMTP_HOST']: 'Alamat server SMTP khusus. Jika SMTP_SERVICE sudah diatur, kosongkan bagian ini.',
  [S.ACI + '_SMTP_PASS']: 'Password email untuk notifikasi. Untuk email QQ/163, masukkan kode otorisasi.',
  [S.ACI + '_SMTP_PORT']: 'Port SMTP khusus. Jika SMTP_SERVICE sudah diatur, kosongkan bagian ini.',
  [S.ACI + '_SMTP_SECURE']: 'TLS khusus untuk SMTP. Isi "true" atau "false". Jika SMTP_SERVICE sudah diatur, kosongkan bagian ini.',
  [S.ACI + '_SMTP_SERVICE']: `Penyedia layanan email untuk notifikasi email. Mendukung: ${smtpServices.join(', ')}`,
  [S.ACI + '_SMTP_USER']: 'Username email untuk notifikasi.',

  ADMIN_CONFIG_RESET: 'Reset',
  ADMIN_CONFIG_SAVE: 'Simpan',
  ADMIN_CREDENTIALS: 'File private key',
  ADMIN_CREDENTIALS_FAQ: 'Cara mendapatkan private key',
  ADMIN_CREDENTIALS_PLACEHOLDER: 'Tempel isi file private key di sini',
  ADMIN_FORGOT: 'Lupa password',
  ADMIN_EXPORT: 'Ekspor',
  ADMIN_EXPORT_WARN: 'Ekspor semua data sebagai file JSON. Jika ekspor gagal atau ada data yang hilang, sambungkan ke database lalu ekspor secara manual.',
  ADMIN_EXPORT_COMMENT: 'Ekspor komentar',
  ADMIN_EXPORT_COUNTER: 'Ekspor penghitung',

  [S.AI]: 'Impor',
  [S.AI + '_FILE_REQUIRED']: 'Belum ada file yang dipilih',
  [S.AI + '_IMPORTED']: 'Berhasil diimpor ',
  [S.AI + '_IMPORTING']: 'Sedang mengimpor ',
  [S.AI + '_LOG']: 'Log',
  [S.AI + '_SELECT']: 'Pilih',
  [S.AI + '_SELECT_FILE']: 'Pilih file',
  [S.AI + '_SELECT_SOURCE']: 'Pilih sumber',
  [S.AI + '_SOURCE_REQUIRED']: 'Belum ada sumber yang dipilih.',
  [S.AI + '_START']: 'Mulai impor',
  [S.AI + '_STARTING']: 'Sedang mengimpor',
  [S.AI + '_TIP_ARTALK']: 'Unggah file ekspor Artalk dalam format JSON. Nama file biasanya comments.data.json',
  [S.AI + '_TIP_DISQUS']: 'Unggah file ekspor Disqus dalam format XML. Nama file biasanya [nama website]-[waktu ekspor]-all.xml',
  [S.AI + '_TIP_VALINE']: 'Unggah file ekspor Valine dalam format JSON. Nama file biasanya Comment.json',
  [S.AI + '_UPLOADED']: 'Berhasil diunggah ',
  [S.AI + '_UPLOADING']: 'Sedang mengunggah ',
  [S.AI + '_WARN']: 'Impor komentar dari sistem komentar lain.\nData tetap aman, dan proses impor berjalan sepenuhnya di lingkungan cloud kamu.\nCadangkan database komentar sebelum melakukan impor.',

  ADMIN_LOGIN: 'Masuk',
  ADMIN_LOGIN_TITLE: 'Panel Manajemen Twikoo',
  ADMIN_LOGOUT: 'Keluar',
  ADMIN_NEED_UPDATE: 'Versi baru Twikoo diperlukan untuk manajemen komentar.',
  ADMIN_PASSWORD: 'Password',
  ADMIN_PASSWORD_PLACEHOLDER: 'Masukkan password...',
  ADMIN_PASSWORD_REQUIRED: 'Masukkan password',
  ADMIN_REGIST: 'Daftar',
  ADMIN_REGIST_FAILED: 'Pendaftaran gagal',
  ADMIN_SET_PASSWORD: 'Atur password',
  ADMIN_SET_PASSWORD_CONFIRM: 'Konfirmasi password',
  ADMIN_SET_PASSWORD_CONFIRM_PLACEHOLDER: 'Konfirmasi password...',
  ADMIN_SET_PASSWORD_PLACEHOLDER: 'Password',
  ADMIN_TITLE: 'Panel Manajemen Twikoo',

  COMMENTS_COUNT_SUFFIX: ' komentar',
  COMMENTS_SORT_NEWEST: 'Terbaru',
  COMMENTS_SORT_OLDEST: 'Terlama',
  COMMENTS_SORT_POPULAR: 'Terpopuler',
  COMMENTS_EXPAND: 'Muat lagi',
  COMMENTS_NO_COMMENTS: 'Belum ada komentar',

  COMMENT_EXPAND: 'Baca selengkapnya',
  COMMENT_COLLAPSE: 'Tutup',
  COMMENT_MASTER_TAG: 'Admin',
  COMMENT_REPLIED: 'Balas',
  COMMENT_DELETE_CONFIRM: 'Hapus komentarmu?',
  COMMENT_REVIEWING_TAG: 'Menunggu moderasi',
  COMMENT_TOP_TAG: 'Disematkan',
  COMMENT_FAILED: 'Komentar gagal dikirim',

  META_INPUT_LINK: 'Website',
  META_INPUT_MAIL: 'Email',
  META_INPUT_NICK: 'Nama',
  META_INPUT_NOT_REQUIRED: 'Opsional',
  META_INPUT_REQUIRED: 'Wajib',

  PAGINATION_COUNT_PREFIX: '',
  PAGINATION_COUNT_SUFFIX: ' entri',
  PAGINATION_GOTO_PREFIX: 'Ke halaman',
  PAGINATION_GOTO_SUFFIX: '',
  PAGINATION_PAGESIZE: 'entri/halaman',

  SUBMIT_CANCEL: 'Batal',
  SUBMIT_PREVIEW: 'Pratinjau',
  SUBMIT_SEND: 'Kirim',

  IMAGE_UPLOAD_PLACEHOLDER: 'Mengunggah gambar',
  IMAGE_UPLOAD_FAILED: 'UNGGAH GAMBAR GAGAL',
  IMAGE_UPLOAD_NSFW: 'Gambar mengandung konten tidak pantas, unggahan ditolak',
  IMAGE_UPLOAD_FAILED_NO_CONF: 'Admin belum mengatur layanan penyimpanan gambar',
  IMAGE_UPLOAD_PLEASE_WAIT: 'Gambar sedang diunggah, coba lagi nanti',

  SUBMIT_SENDING: 'Mengirim',

  TIMEAGO_DAYS: 'hari lalu',
  TIMEAGO_HOURS: 'jam lalu',
  TIMEAGO_MINUTES: 'menit lalu',
  TIMEAGO_NOW: 'Baru saja',
  TIMEAGO_SECONDS: 'detik lalu'
}
...
export default {
  ...
  [S.ACI + '_SHOW_DISLIKE']: [
    ...
    '評論點踩按鈕，預設為：true',
    '評論點踩按鈕，預設為：true',
    'Show dislike button. Default: true.',
